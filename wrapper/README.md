...
`itb_wrapper_cipher_name` returns the canonical short name (`"aescmac"` / `"chacha20"` / `"siphash24"`) as an interned NUL-terminated C string the caller MUST NOT free.
